...
angular.module('app').constant('JQ_CONFIG', {
  ...
  plot: [
    'libs/vendor/jquery/charts/flot/jquery.flot.min.js',
  ...
  footable: [
    'libs/vendor/jquery/footable/footable.all.min.js',
    ...
    $ocLazyLoadProvider.config({
      ...
      modules: [
        ...
        },
        {
          ...
          files: ['libs/vendor/modules/angular-file-upload/angular-file-upload.min.js']
        },
        {
          name: 'ui.calendar',
        ...
        },
        {
          ...
          files: ['libs/vendor/modules/videogular/videogular.min.js']
        },
        {
          name: 'com.2fdevs.videogular.plugins.controls',
          files: ['libs/vendor/modules/videogular/plugins/controls.min.js']
        },
        {
          name: 'com.2fdevs.videogular.plugins.buffering',
          files: ['libs/vendor/modules/videogular/plugins/buffering.min.js']
        },
        {
          name: 'com.2fdevs.videogular.plugins.overlayplay',
          files: ['libs/vendor/modules/videogular/plugins/overlay-play.min.js']
        },
        {
          name: 'com.2fdevs.videogular.plugins.poster',
          files: ['libs/vendor/modules/videogular/plugins/poster.min.js']
        },
        {
          name: 'com.2fdevs.videogular.plugins.imaads',
          files: ['libs/vendor/modules/videogular/plugins/ima-ads.min.js']
        }
      ]
    });
  }
